...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.toolBox.setMaximumSize(QtCore.QSize(291, 16777215))
        self.toolBox.setObjectName("toolBox")
        self.page = QtWidgets.QWidget()
        self.page.setGeometry(QtCore.QRect(0, 0, 291, 823))
        ...
        self.page_2.setGeometry(QtCore.QRect(0, 0, 291, 823))
        ...
        self.toolBox.layout().setSpacing(100)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "潜力区筛选"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page), _translate("MainWindow", "潜力区筛选"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_2), _translate("MainWindow", "Page 2"))
        self.toolBox.setItemText(self.toolBox.indexOf(self.page_3), _translate("MainWindow", "页"))
